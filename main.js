function handleClick() {
  ...
  $("#success").append("IP address copied to clipboard.")
}
...
document.getElementById("age").innerHTML = `the world is <strong>${nigger} days</strong> old and it's size is over <strong>30 gigabytes</strong><br> with over <strong>400 people</strong> visiting.`;
